...
This repository contains Axiom `1.0.17`, a stable release with MCP client and server support, manifest hooks, OpenCode Zen & GMI Cloud providers, thinking mode toggle, process termination guards, live code animation, auto-testing engine, and runtime provider management:
