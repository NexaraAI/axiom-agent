...
This repository contains Axiom `1.0.10`, a stable release with OpenCode Zen & GMI Cloud providers, thinking mode toggle, process termination guards, live code animation, auto-testing engine, and runtime provider management:
